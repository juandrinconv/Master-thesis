...
Q_LIST = np.array([30, 45, 60, 70])
S_LIST = np.array([3.88, 6.35, 10.26, 14.16])
...
if __name__ == '__main__':
    ...
    initial_guess = [0.0001, 0.0001, 0.0001, 3.18]
    lower_bounds = [-2, -2, -2, 0.35]
    upper_bounds = [2, 2, 2, 6.01]
    ...
    # Root
    root_initial = [0.0001, 0.0001, 0.0001, 4]
