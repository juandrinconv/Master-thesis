...
annotate_label(
    2, y[2]-lower[2],
    f"{(y[2]-lower[2]):.3f}",
    1.85, y[2]-lower[2]-0.5,
    align='right', color='black')
annotate_label(
    2, y[2]+upper[2],
    f"{(y[2]+upper[2]):.3f}",
    1.85, y[2]+upper[2]+0.1,
    align='right', color='black')
...
annotate_label(
    3, y[3]-lower[3],
    f"{(y[3]-lower[3]):.3f}",
    2.55, y[3]-lower[3]-0.2,
    align='right', color='black',
    fontsize=8)
annotate_label(
    3, y[3]+upper[3],
    f"{(y[3]+upper[3]):.3f}",
    2.55, y[3]+upper[3]+0.11,
    align='right', color='black',
    fontsize=8)
