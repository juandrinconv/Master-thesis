...
annotate_label(
    1, y[1]-lower[1],
    f"{(y[1]-lower[1]):.3e}",
    0.9, y[1]-lower[1]-0.003,
    align='right', color='black')
annotate_label(
    1, y[1]+upper[1],
    f"{(y[1]+upper[1]):.3e}",
    0.9, y[1]+upper[1]+0.01,
    align='right', color='black')
...
annotate_label(
    0, y[0]-lower[0],
    f"{(y[0]-lower[0]):.3f}",
    0.2, y[0]-lower[0]-0.04,
    align='left', color='black')
annotate_label(
    0, y[0]+upper[0],
    f"{(y[0]+upper[0]):.3f}",
    0.2, y[0]+upper[0]+0.06,
    align='left', color='black')
...
annotate_label(
    ...
    1.85, y[2]-lower[2],
    align='right', color='black')
annotate_label(2, y[2]+upper[2], f"{(y[2]+upper[2]):.3f}",
               1.85, y[2]+upper[2], align='right', color='black')

# 3. Propuesta
plt.sca(axs[2])
axs[2].set_title("Rincón's Equation (2025)", fontsize=12)
...
annotate_label(
    3, y[3]-lower[3],
    f"{(y[3]-lower[3]):.3f}",
    2.55, y[3]-lower[3]-0.02,
    align='right', color='black',
    fontsize=8)
annotate_label(
    3, y[3]+upper[3],
    f"{(y[3]+upper[3]):.3f}",
    2.55, y[3]+upper[3]+0.03,
    align='right', color='black',
    fontsize=8)
